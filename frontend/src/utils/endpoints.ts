const endpoints = {
  ...
  permissoes: {
    getAll: '/permissoes/',
    create: '/permissoes/create',
    getById: (id: string) => `/permissoes/${id}`,
    update: (id: string) => `/permissoes/edit/${id}`,
    delete: (id: string) => `/permissoes/delete/${id}`,
  },
  departamentos: {
  ...
  fornecedores: {
    ...
    exportProdutosPdf: (id: string) =>
      `/fornecedores/${id}/produtos/export/pdf`,
  },
  produtos: {
    getAll: '/produtos',
